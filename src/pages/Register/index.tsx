  ...
  return (
    <div className="h-[70vh] relative flex items-center justify-center sm:h-[50vh]">
      <div className="text-center relative z-10 text-[white]">
        <h1 className="text-2xl py-8">Đăng Ký Mới</h1>
        <div className="bg-[#1c262f] py-10 w-[600px] sm:w-full">
          <div className="flex justify-between items-center w-[90%] m-auto my-6">
            <h1 className="text-[#bfc9d2] font-semibold">Họ và Tên (*)</h1>
            <input
          ...
          <div className="flex justify-between items-center w-[90%] m-auto my-6 sm:text-sm sm:w-full sm:gap-3">
            <button className="bg-[#64b12a] px-10 py-3 rounded">ĐĂNG KÝ</button>
            <Link to="/dang-nhap">
      ...
      <img
        className="absolute top-0 left-0 sm:w-full sm:h-full"
        src={BackGround}
        alt=""
      />
    </div>
